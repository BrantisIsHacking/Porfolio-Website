...
const About = () => {
  return (
    <div className="about-container">
      ...
      <p>
        Beyond academics, I actively engage in extracurricular activities, including FIRST Robotics Team, MCC Club, Key Club, TSA STEM Club, and Varsity Basketball and Golf teams. These experiences have nurtured my leadership skills, teamwork abilities, and a well-rounded personal development.
      </p>
      <p>
        I am a dedicated and driven individual, recognized as a member of the National Honor Society and National Technical Honor Society. With a passion for technology and a commitment to continuous learning, I strive to make a positive impact through my work and contributions.
      </p>
    </div>
  );
};
